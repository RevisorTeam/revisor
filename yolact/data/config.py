...
my_custom_dataset_v3 = dataset_base.copy({
    'name': 'dataset_v3',

    'train_images': './dataset_v2/',
    'train_info':   './dataset_v2/ann_train.json',

    'valid_images': './dataset_v3/',
    'valid_info':   './dataset_v3/ann_valid.json',

    'has_gt': True,
    'class_names': ('ballot_box')
})

my_custom_dataset_v4 = dataset_base.copy({
    'name': 'dataset_v4',

    'train_images': './dataset_v4/',
    'train_info':   './dataset_v4/ann_train.json',

    'valid_images': './dataset_v4/',
    'valid_info':   './dataset_v4/ann_valid.json',

    'has_gt': True,
    'class_names': ('ballot_box', 'koib')
})

caps_v1_dataset = dataset_base.copy({
    'name': 'caps_v1_dataset',

    'train_images': './caps_v1_dataset/',
    'train_info':   './caps_v1_dataset/ann_train.json',

    'valid_images': './caps_v1_dataset/',
    'valid_info':   './caps_v1_dataset/ann_valid.json',

    'has_gt': True,
    'class_names': ('ballot_box', 'koib')
})

my_test_dataset = dataset_base.copy({
    'name': 'my_test_dataset',

    'valid_images': './dataset_test/',
    'valid_info':   './dataset_test/ann_test.json',

    'has_gt': True,
    'class_names': 'ballot_box'
})

my_test_dataset_v3 = dataset_base.copy({
    'name': 'my_test_dataset_v3',

    'valid_images': './dataset_test_v3/',
    'valid_info':   './dataset_test_v3/ann_test.json',

    'has_gt': True,
    'class_names': ('ballot_box', 'koib', 'none')
})

my_test_dataset_v3_mini = dataset_base.copy({
    'name': 'my_test_dataset_v3_mini',

    'valid_images': './dataset_test_v3/',
    'valid_info':   './dataset_test_v3/ann_test_mini.json',
...
yolact_im700_config_v3 = yolact_base_config.copy({
    'name': 'yolact_im700_v3',

    'dataset': my_custom_dataset_v3,
    'num_classes': len(my_custom_dataset_v3.class_names) + 1,
...
yolact_im700_config_v4 = yolact_base_config.copy({
    'name': 'yolact_im700_v4',

    'dataset': my_custom_dataset_v4,
    'num_classes': len(my_custom_dataset_v4.class_names) + 1,
...
yolact_im700_config_cap_v1 = yolact_base_config.copy({
    'name': 'yolact_im700_cap_v1',

    'dataset': caps_v1_dataset,
    'num_classes': len(caps_v1_dataset.class_names) + 1,
